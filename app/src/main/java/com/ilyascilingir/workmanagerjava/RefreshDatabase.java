package com.ilyascilingir.workmanagerjava;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase (int myNumber){
        ...
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.ilyascilingir.workmanagerjava",Context.MODE_PRIVATE);
